...
// http(s) 之外，也认「软件自己的链接协议」——比如 Calibre 的 calibre://、
// Obsidian 的 obsidian://，这样才能把「点开就跳到本地软件里那本书/那篇笔记」
// 的链接当成正常条目保存，而不是被当成没有链接的纯文本。
const URL_RE = /[a-zA-Z][a-zA-Z0-9+.-]{1,30}:\/\/[^\s<>"']+/i;
